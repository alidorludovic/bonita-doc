 ...
 ** Please make sure to use the link:database-configuration.md#proprietary_jdbc_drivers[appropriate JDBC driver]
 ** WARNING: *Oracle database* requires to use the official driver for each specific version. Make sure your driver's checksum matches the Oracle official one for your link:database-configuration.md#proprietary_jdbc_drivers[database version]
:::
