...
+++<a id="living-application-development-and-deployment">++++++</a>+++
...
+++<a id="ui-designer-performance">++++++</a>+++
...
Attention: if your applications layout is based on the default layout, see how to link:customize-living-application-layout.md#improve-navigation[update your custom layout] to take advantage of this improvement.
...
+++<a id="engine-start-performance">++++++</a>+++
