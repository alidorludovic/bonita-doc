...
use the link:database-configuration.md#proprietary_jdbc_drivers[jdbc driver] provided by Oracle.
...
. In TOMCAT_DIRECTORY/setup/lib add your jdbc driver if needed (only for Oracle, see link:database-configuration.md#proprietary_jdbc_drivers[proprietary jdbc drivers])
